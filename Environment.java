...
public class Environment implements IEnvironment{
    ...
    public Environment(){
        ...
        // upper inner walls 
        addObstacle(new Point2D(240, 4), new Point2D(243, 175), new Point2D(240, 4));
        addObstacle(new Point2D(480, 4), new Point2D(483, 90), new Point2D(480, 4));

        // left inner wall(s)
        addObstacle(new Point2D(4, 240), new Point2D(90, 243), new Point2D(4, 240));

        // right inner wall(s)
        addObstacle(new Point2D(580, 180), new Point2D(797, 183), new Point2D(797, 183));

        // bottom inner wall(s)
        addObstacle(new Point2D(450, 280), new Point2D(453, 397), new Point2D(453, 397));

        /* ~~~)}------- <| 0b$7acl£$ |> ------{(~~~ */
        // top left
        addObstacle(new Point2D(90, 90), new Point2D(150, 150), null);

        // middle one
        addObstacle(new Point2D(300, 300), new Point2D(330, 330), null);

        // right one
        addObstacle(new Point2D(570, 270), new Point2D(680, 340), null);
